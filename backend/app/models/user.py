...
class User(Base):
    ...
    branch = Column(String(200), default="Computer Science and Engineering")
    batch = Column(String(10), default="2025")
    college = Column(String(200), default="VIT - Assessment Portal")
